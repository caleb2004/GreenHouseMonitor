...
public class LoginActivity extends AppCompatActivity {
    ...
    //Rob: Disabled the log in activity. Should go right to connecting to bluetooth now!
    @AfterViews
    void startMainActivity() {

        /*
        Log.e("ROB","StartMainActivity called");
    ...
    */
//Rob changed to always sign in
        Log.e("ROB","Signed in okay");
       Toast.makeText(this,"Starting scan",Toast.LENGTH_LONG);
        if (true) {
            credentials.username().put("Demo");
            MainActivity_.intent(LoginActivity.this).start();
            finish();
