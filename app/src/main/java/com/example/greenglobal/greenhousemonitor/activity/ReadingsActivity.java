package com.example.greenglobal.greenhousemonitor.activity;
...
import com.example.greenglobal.greenhousemonitor.model.Mode;
...
import com.example.greenglobal.greenhousemonitor.util.Dialog;
import com.example.greenglobal.greenhousemonitor.util.HexiwearDevices;
//import com.example.greenglobal.greenhousemonitor.view.Reading;
//import com.example.greenglobal.greenhousemonitor.view.SingleReading;
//import com.example.greenglobal.greenhousemonitor.view.TripleReading;
...
public class ReadingsActivity extends AppCompatActivity implements ServiceConnection {
    ...
    */
    ...
    void onModeChanged(final Mode mode) {
        this.mode = mode;
    ...
    void onConnectionStateChanged(final boolean connectionState) {
